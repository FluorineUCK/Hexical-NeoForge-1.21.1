...
class TransmutingEmi(id: ResourceLocation, val recipe: TransmutingRecipe) : BasicEmiRecipe(HexicalEmi.TRANSMUTING_CATEGORY, id, 134, 52) {
	init {
	...
	companion object {
		private val OVERLAY: ResourceLocation = HexicalMain.id("textures/gui/transmuting_emi.png")
	}
}
