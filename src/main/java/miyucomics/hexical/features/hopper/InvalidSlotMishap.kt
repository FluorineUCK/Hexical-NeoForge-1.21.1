...
class InvalidSlotMishap(val iota: Iota, val attemptedSlot: Int) : Mishap() {
	...
	override fun errorMessage(env: CastingEnvironment, errorCtx: Context): Component = error(HexicalMain.MOD_ID + ":invalid_slot", attemptedSlot, iota.display())
